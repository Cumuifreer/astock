...
DEFAULT_STRATEGY_CONFIG: Dict[str, Any] = {
    ...
    "platform_breakout_require_close_above": False,
    "platform_breakout_clearance_mode": "off",
    "platform_breakout_clearance": None,
    "platform_breakout_max_clearance": None,
    ...
    "platform_breakout_volume_ratio": None,
    ...
    "platform_ma_trend_enabled": False,
    "platform_ma_bullish_mode": "off",
    "platform_ma_rising_required": False,
    "platform_ma_rising_mode": "off",
    "platform_macd_filter_mode": "off",
    "platform_setup_lookback_days": 20,
    "platform_setup_max_range": None,
    "platform_setup_max_distance_to_high": None,
    "platform_setup_max_recent_gain_5d": None,
    "platform_setup_volume_contraction_max": None,
    "platform_setup_bull_volume_advantage": None,
    "platform_setup_ma_convergence_max": None,
    "platform_setup_require_ma_turning": False,
    "platform_setup_macd_mode": "none",
    ...
    "trend_require_price_above_ema_long": False,
    "trend_require_ema_long_rising": False,
    "trend_require_ema_fast_above_mid": False,
    "trend_macd_mode": "off",
    "trend_stoch_mode": "off",
    "trend_max_ema_mid_distance": None,
    "trend_max_recent_gain_10d": None,
    "trend_stoch_overheat": None,
...
LEGACY_SIGNAL_DEFAULTS: Dict[str, Any] = {
...
def normalize_strategy_config(config: Optional[Dict[str, Any]]) -> Dict[str, Any]:
    ...
    if raw_config.get("version") != 2 and raw_signal_mode in LEGACY_SIGNAL_MODES:
        for key, value in LEGACY_SIGNAL_DEFAULTS.items():
