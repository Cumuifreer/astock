...
export interface StrategyConfig {
  ...
  preset_key: string;
  signal_mode: string;
  platform_breakout_enabled: boolean;
  platform_setup_enabled: boolean;
  trend_resonance_enabled: boolean;
  ...
  atr_window: number;
  atr_pct_mode: string;
  min_atr_pct: number | null;
  max_atr_pct: number | null;
  bollinger_window: number;
  bollinger_std: number;
  bollinger_width_mode: string;
  max_bollinger_width: number | null;
